          ...
          <div className="max-w-6xl mx-auto mb-32">
            ...
            <div className="mb-16">
              <p className="text-3xl lg:text-4xl text-white leading-[1.3] font-medium mb-12">
                Traditional racehorse ownership — expensive, restrictive, and opaque — has historically excluded those
                who dream of experiencing the thrill firsthand.
              </p>
            </div>

            {/* Solution Statement */}
            <div className="space-y-8 mb-12">
              <p className="text-2xl lg:text-3xl leading-[1.4] max-w-5xl">
                <span className="text-white font-semibold">Evolution Stables</span>{" "}
                <span className="text-gray-400 font-normal">removes these barriers, delivering ownership that's</span>{" "}
                <span className="text-white font-bold">genuinely accessible</span>,{" "}
                <span className="text-white font-bold">fully transparent</span>, and{" "}
                <span className="text-white font-bold">uniquely liquid</span>.
              </p>
            </div>
